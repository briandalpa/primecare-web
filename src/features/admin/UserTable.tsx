          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b text-left">
                ...
                <th className="pb-3 font-medium text-muted-foreground hidden lg:table-cell">Joined</th>
            ...
            <tbody>
              {users.map((user) => (
                <tr key={user.id} className="border-b last:border-0">
                  ...
                  <td className="py-3 hidden sm:table-cell text-muted-foreground">{user.email}</td>
                  <td className="py-3"><RoleBadge role={user.role} /></td>
